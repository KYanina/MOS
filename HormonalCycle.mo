package HormonalCycle
  ...
  Hp Hp_LH(S = E2, T = T_LH_E2, n = n_LH_E2);//syn
  Hm Hm_LH(S = P4, T = T_LH_P4, n = n_LH_P4);//syn
  ...
  // ====== FSH ======
  parameter Real freq=3.179;/*parameter/Not sure about units 1/d /  described by algebraic equation page 29 bio...494.pdf*/
