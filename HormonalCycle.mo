...
//  der(R_FSH_des) = k_FSH_des * FSH_R - k_FSH_recy * R_FSH_des;
    ...
    //====== Input and Output ======
      ...
      Modelica.Blocks.Interfaces.RealInput RelFSH annotation(
        Placement(visible = true, transformation(origin = {-70, -46}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput LH_blood(start = 3.487) "IU/L" annotation(
        Placement(visible = true, transformation(origin = {86, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {90, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput LH_R(start = 0.332) "IU/L" annotation(
        Placement(visible = true, transformation(origin = {86, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {90, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput FSH_blood(start = 6.286) "IU/L" annotation(
...
//Equations, describing FSH in serum and for its receptor's complex
    ...
    model GlandPit
      ...
      Modelica.Blocks.Interfaces.RealInput P4 annotation(
        Placement(visible = true, transformation(origin = {-84, 48}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-59, 13}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput IhAe annotation(
        Placement(visible = true, transformation(origin = {-98, -10}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-59, -19}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput IhB annotation(
        Placement(visible = true, transformation(origin = {-114, -40}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-59, -71}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
  ...
  //FSH Pitatory gland
    ...
    // parameter Real freq = 3.179;
    //make as input
    /*parameter/? units 1/d /  described by algebraic equation page 29 bio...494.pdf*/
    ...
    model Ovaries
      ...
      Modelica.Blocks.Interfaces.RealOutput E2(start = 30.94) "pg/mL" annotation(
        Placement(visible = true, transformation(origin = {-84, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {70, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput IhAe(start = 52.43) "IU/mL" annotation(
        Placement(visible = true, transformation(origin = {-84, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {70, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput IhB(start = 72.17) "pg/mL" annotation(
        Placement(visible = true, transformation(origin = {-84, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {70, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput LH_blood annotation(
        Placement(visible = true, transformation(origin = {-72, 88}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput LH_R annotation(
        Placement(visible = true, transformation(origin = {-62, 98}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 40}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput FSH_blood annotation(
        Placement(visible = true, transformation(origin = {-52, 108}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-80, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput FSH_R annotation(
